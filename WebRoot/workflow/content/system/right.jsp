...
<meta name="viewport"
	...
	<script src="${ctx}/js/shCore.js" type="text/javascript"></script>
	<script src="${ctx}/js/shBrushXml.js" type="text/javascript"></script>
	<script src="${ctx}/js/shBrushJava.js" type="text/javascript"></script>
